...
${chalk.blue.italic('ℹ️ Connecting to WhatsApp...')}`);
    ...
    conn.on('open', async () => {
        ...
        console.log(
            ...
            chalk.green.bold('Foxy is Working🦊 ' + config.WORKTYPE + ' 𝚗𝚘𝚠 🍃'));
          ...
          if (config.LANG == 'EN' || config.LANG == 'ML') {
                ...
                if (commits.total === 0) {
                    ...
                    await conn.sendMessage(
                        ...
                        '*◄━⦁🦊 FOXY🦊⦁━►*' + degisiklikler + '```', MessageType.text
...
*/
                        ...
                        try {
                            ...
                            if (config.LANG == 'TR' || config.LANG == 'AZ') {
                                ...
                                await conn.sendMessage(conn.user.jid, '*~_________~ FOXIT ~______~*' +
